...
1. Read [AGENTS.md](AGENTS.md) - Our comprehensive guide for AI coding agents and contributors
2. Review [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md) - Detailed contribution guidelines
3. Check existing [issues](https://github.com/orneryd/NornicDB/issues) and [pull requests](https://github.com/orneryd/NornicDB/pulls)
